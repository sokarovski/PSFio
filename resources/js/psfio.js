...
PS.PSFio = function () {
    ...
    _class.prototype.findDefaultRenderer = function findDefaultRenderer(preferedRenderer) {
        ...
        if (preferedRenderer) this.setRenderer(preferedRenderer);else if (sessionRenderer = localStorage.getItem('psfio-renderer')) this.setRenderer(PS.PSFio.Renderers[sessionRenderer]);else this.setRenderer(PS.PSFio.Renderers.Table);
    };
